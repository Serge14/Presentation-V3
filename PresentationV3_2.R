...
build.bar.chart = function(df, selection, measure, 
  ...
  if (reporting.Mnb < 12){
    df.temp = data.table(Ynb = reporting.Ynb,
                         ...
                         NA,
                         NA)
    df = rbindlist(list(df, df.temp), use.names = FALSE)
  }
...
dictColors = fread("/home/serhii/Documents/Work/Nutricia/Scripts/Presentation-V2/dictColor.csv")
...
growth.imf.volume = 0.9482
growth.imf.value = 0.99953
growth.foods.volume = 1.02956
growth.foods.value = 1.05224
...
ppt <- read_pptx("/home/serhii/Documents/Work/Nutricia/Scripts/Presentation-V3/Market Research data - pattern3.pptx")
dictContent = read.csv("/home/serhii/Documents/Work/Nutricia/Scripts/Presentation-V3/dictContent.csv",
...
for (i in dictContent[, Slide]) {
  ...
  if (dictContent[Slide == i, Type == "Bar chart"]) {
    ppt %>%
      ...
      location = ph_location_type(type = "body", id = 5)) %>%
      ...
      location = ph_location_type(type = "body", id = 4))
  ...
  if (dictContent[Slide == i, Type == "Line chart"]) {
    ppt %>%
      ...
      location = ph_location_type(type = "body", id = 3)) %>%
  ...
  if (dictContent[Slide == i, Type == "Brands"]) {
    ...
    ph_with(
      ...
      location = ph_location_type("body", id = 3)
    ) %>%
...
print(ppt, "/home/serhii/Documents/Work/Nutricia/Scripts/Presentation-V3/Market Research Data Aug20.pptx")

# print(ppt, "/home/sergiy/Documents/Work/Nutricia/Scripts/Presentation-V3/Market Research Data Jun20.pptx")
